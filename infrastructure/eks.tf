...
module "eks" {
  ...
  access_entries = {
    # admin
    admin = {
      principal_arn = data.aws_iam_roles.admin_sso_role.arns[0]
    ...
    # qa
    qa = {
      principal_arn = data.aws_iam_roles.qa_sso_role.arns[0]
    ...
    # admin
    dev = {
      principal_arn = data.aws_iam_roles.dev_sso_role.arns[0]
